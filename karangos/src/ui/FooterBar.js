    ...
    return (
        <Toolbar className={classes.toolbar}>
            <Typography variant='caption' display='block' color='textSecondary' align='center' className={classes.text}>
                Produzido com <LocalCafeIcon fontSize='small' /> por <a className={classes.link} href='https://github.com/OtavioCleyderman' target="_blank" rel="noreferrer">Otávio Cleyderman</a>
            </Typography>
        </Toolbar>
    )
}